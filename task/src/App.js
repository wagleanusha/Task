...
function App() {
  ...
  const sortByName = () => {
    const tblValues = [...tableValues];
    if (sort) tblValues.sort((a, b) => a.username.localeCompare(b.username));
    else tblValues.sort((a, b) => b.username.localeCompare(a.username));
      ...
      {tableValues.length > 0 ? (
        <>
          ...
          <table>
            <tr>
              <th>
                <a class="sort-by" onClick={sortByName}>
                  Name
                </a>
              </th>
              <th>Email</th>
